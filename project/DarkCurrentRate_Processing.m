...
figure(1)
hold on
%f = fitlm(data_55T_avg, 'exposureTime', 'imgMean')
%plot(f, data_55T_avg.exposureTime, data_55T_avg.imgMean)
scatter(data_55T_avg.exposureTime, data_55T_avg.imgMean)
lsline
scatter(data_395T_avg.exposureTime, data_395T_avg.imgMean)
lsline

% figure(2)
% hold on
%f = fit(data_798T_avg.exposureTime, data_798T_avg.imgMean, 'linearinterp')
%plot(f, data_798T_avg.exposureTime, data_798T_avg.imgMean)
scatter(data_798T_avg.exposureTime, data_798T_avg.imgMean)
...
text(10e-3, 64, theString, 'FontSize', 12);
...
scatter(data_99T_avg.exposureTime, data_99T_avg.imgMean, 'r', 'DisplayName', '55')
plot(data_99T_avg.exposureTime, orig1, '--r', [0 60e-3], xtnd1, '--r', 'DisplayName', '55')
...
xtnd1 = polyval(bestfit1, [0 60e-3]);
disp_pr_s = bestfit1(1)*data_99T_avg.exposureTime + bestfit1(2);
scatter(data_99T_avg.exposureTime, data_99T_avg.imgMeanNorm, 'r', 'DisplayName', '55')
plot(data_99T_avg.exposureTime, orig1, '--r', [0 60e-3], xtnd1, '--r', 'DisplayName', '55')
theString = sprintf('99: y = %.3f x + %.3f', bestfit1(1), bestfit1(2));
text(10e-3, 64, theString, 'FontSize', 12);
